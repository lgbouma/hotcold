...
\begin{abstract}
\normalfont
A small fraction of red dwarfs younger than 100 million years show
...
star's equatorial velocity, which provides the first direct evidence for
corotating plasma clumps around a CPV.  While cool ($10^4$ K)
plasma can persist within the hot ($10^6$ K) coronae of
rapidly-rotating stars across a broad range of masses
\cite{CollierCameron1989,Townsend2005,Dunstone2006,Petit2013,Waugh2022,Daley-Yates2024},
our observations suggest that red dwarfs in particular can
sustain long-lived, optically thick clumps that generate the 
sharp photometric features seen in CPVs.  The origin of this
...
complex light curves \cite{Bouma2024}.   One interpretation for this
...
time-series spectra of a CPV, and they demonstrate that
...
\cite{Koen2021} is incompatible with our observations.
