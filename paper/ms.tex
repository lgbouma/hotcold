...
charged particles \added{along any given field line }has a local minimum outside $R_{\rm c}$, which enables
...
gas}\approx 2\times10^{17}$\,g\added{, similar to those derived for
other cool stars \citep{VillarrealDAngelo2019}.}.  We emphasize that
