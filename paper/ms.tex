...
\cite{Gunther2020}.  However, despite excellent work in these areas,
...
\begin{figure}[!t]
  ...
  variable (CPV).}  The online movie, available
...
\cite{Ricker2015} for stars showing at least three sharp, periodic
dips per cycle.  We selected the star for spectroscopy because its
brightness and rotation rate enable efficiently mapping out any line
profile variability.  We observed for five hours on 17~February~2024
...
26~February~2024 with a duty cycle of 77\%.  During the spectral
...
2: Pre-main sequence Gaia DR3 photometry, but lacks of lithium (see~\ref{subsec:stparams}).
...
analogous objects \cite{Tanimoto2020,Gunther2022,Koen2023}.  This
