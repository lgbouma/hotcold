...
a good first approximation, but one that will need refinement in future
work.}
...
the flux dips occur when clumps of circumstellar
...
observed spectra.  We averaged the redshift
measurements over each order, and
...
that $\approx$30\% of CPVs show evidence for binarity from RUWE, and $\approx$40\% of CPVs show
evidence for binarity based on the presence of
secondary photometric periods.  This agrees with analyses showing that
multi-periodic low-mass stars are usually unresolved binaries
