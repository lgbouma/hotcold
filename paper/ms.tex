...
an instructive recent overview: an abbreviated summary is that the M
dwarfs that have not yet had time to burn their photospheric lithium
show the lithium 6707.8\,\AA doublet in absorption, $\gtrsim$10\%
below their ``continua''.  Relative to Sun-like stars, defining the
continuum for cool M dwarfs requires care due to their complex
spectra.  To attempt a lithium measurement, we constructed a
wavelength-binned and Doppler-corrected TIC~141146667 spectrum,
assigned its uncertainties based on the measured scatter across the
five hour dataset, and compared against the nearest matching template
from \cite{Bochanski2007}.  The data show a slight depression near the
expected lithium wavelength, potentially consistent with a $\Delta
\lambda$$\approx$3\,\AA line broadening.  This feature nominally
yields ${\rm EW}_{Li}$=71$^{+18}_{13}$\,m\AA, where the statistical
...
we therefore prefer to quote the results of this measurement as a
$2\sigma$ upper limit: ${\rm EW}_{Li}$$<$107\,m\AA.
...
Frankly, it's not obviously there!  (but maybe
