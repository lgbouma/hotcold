...
are present around at least one such star.
This
...
\begin{figure}[!b]
  ...
  {\bf a,} TESS simple aperture photometry. 
  ...
  sampling.
  {\bf b-c,} Folded light curve before and after spectroscopy.
...
that of the star.
Assuming the emitting volume is a homogeneous sphere of radius $r$, we can write
\begin{align}
  n_{\rm H} &= 
  %\frac{1}{x}
  %\left(
  ...
  \right)^{3/2}.
\end{align}
Given that we have assumed a uniform density clump, this suggests a total
gas mass at the stated nominal parameters of $M_{\rm gas}\approx 8\times10^{16}$\,g.
