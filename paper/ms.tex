...
available data.  We caution that the following estimates are coarse:
detailed considerations of radiative transfer and detailed balance are
a worthwhile topic for future work, but are beyond the scope of this
article.
...
Assuming a uniform density clump, this yields $M_{\rm gas}\approx
8\times10^{16}$\,g.
...
precision infrared spectrophotometry---would provide a pathway for
distinguishing between environments that more closely resemble the
interstellar medium versus protoplanetary disks.
