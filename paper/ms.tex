...
\citet{GaiaCollaboration2018}, assuming that $A_0 = 3.1 E(B-V)$.

Figure~\ref{fig:camd} suggests that TIC~141146667 is
older than USco, and potentially younger than the Pleiades.  The precision of this
statement is set by the intrinsic scatter of the calibration
sequences; the most luminous stars in the Pleiades of the same color
have a similar absolute magnitude as TIC~141146667.
Previous work \cite{Stauffer2021} has noted that in the Gaia
passbands, CPVs tend to be photometrically redder and more luminous
than single stars in any given cluster.
While this effect complicates any attempt at age inference based on this
photometry, it suggests that the Pleiades may be a better comparison
population than IC~2602.
Broadly, we take the star's isochrone location to suggest age bounds
$t_{\rm CAMD}$$\sim$40-150\,Myr.
...
Li,th}$$\gtrsim$35\,Myr would be expected for complete depletion (see
...
\begin{figure}[!t]
  ...
  that have arrived at the main sequence are typically 1.5\,magnitudes
