...
%
$M_\star$\dotfill                       & Stellar mass ($M_\odot$)\dotfill                               & XXX  &           & 3 \\
%
$\gamma$\dotfill                        & Systemic radial velocity (\kms)\dotfill                        & 0.61 $\pm$ 1.47  & 4 \\
%
Spec. Type\dotfill                      & Spectral Type\dotfill                                          & MXV              & 4 \\ % TODO TODO
%
...
Ref.~\cite{Gray2008}; taking the mean and standard deviation of the
result value over all epochs yielded $v_{\rm eq} \sin
